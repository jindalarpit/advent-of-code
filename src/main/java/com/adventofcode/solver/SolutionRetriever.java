...
import com.adventofcode.annotations.AdventOfCodeSolution;
...
public class SolutionRetriever {
    ...
    public List<Solution<?>> retrieveSolutions(SolverArguments arguments) {
        ...
        Set<Class<?>> solutionClasses = new Reflections("com.adventofcode.solution").getTypesAnnotatedWith(AdventOfCodeSolution.class);
